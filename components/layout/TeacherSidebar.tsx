...
import {
  LayoutDashboard, BookOpen, BarChart2, Settings, MessageSquare,
  Plus, HelpCircle, LogOut, GraduationCap, X, Menu, FileText, ClipboardList
} from "lucide-react"
...
const navigation = [
  ...
  { name: "My Classes", href: "/teacher/courses", icon: BookOpen },
  { name: "Quizzes", href: "/teacher/quizzes", icon: GraduationCap },
  { name: "Exercises", href: "/teacher/exercises", icon: FileText },
  { name: "Exam Prep", href: "/teacher/exam-prep", icon: ClipboardList },
  { name: "Students", href: "/teacher/students", icon: BarChart2 },
  { name: "Certificates", href: "/teacher/certificates", icon: Settings },
  { name: "Testimonials", href: "/teacher/testimonials", icon: MessageSquare },
]
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pb-3 border-t border-gray-100 pt-4 shrink-0">
        <Link
          ...
          className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#1a237e] text-white rounded-lg text-sm font-semibold hover:bg-[#283593] transition-colors shadow-sm touch-target"
        >
